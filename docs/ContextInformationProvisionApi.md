...
# **append_attrs**
> append_attrs(entity_id, type=type, options=options, local=local, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Append Attributes to Entity 
        api_instance.append_attrs(entity_id, type=type, options=options, local=local, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
...
# **delete_attrs**
> delete_attrs(entity_id, attr_id, delete_all=delete_all, dataset_id=dataset_id, type=type, local=local, link=link, ngsild_tenant=ngsild_tenant)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Attribute delete 
        api_instance.delete_attrs(entity_id, attr_id, delete_all=delete_all, dataset_id=dataset_id, type=type, local=local, link=link, ngsild_tenant=ngsild_tenant)
    except Exception as e:
...
# **delete_batch**
> delete_batch(local=local, link=link, ngsild_tenant=ngsild_tenant, request_body=request_body)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Batch Entity Delete 
        api_instance.delete_batch(local=local, link=link, ngsild_tenant=ngsild_tenant, request_body=request_body)
    except Exception as e:
...
# **delete_entity**
> delete_entity(entity_id, type=type, local=local, link=link, ngsild_tenant=ngsild_tenant)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Entity deletion by id 
        api_instance.delete_entity(entity_id, type=type, local=local, link=link, ngsild_tenant=ngsild_tenant)
    except Exception as e:
...
# **merge_entity**
> merge_entity(entity_id, options=options, type=type, observed_at=observed_at, lang=lang, local=local, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Entity merge by id 
        api_instance.merge_entity(entity_id, options=options, type=type, observed_at=observed_at, lang=lang, local=local, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
    except Exception as e:
...
# **replace_attrs**
> replace_attrs(entity_id, attr_id, local=local, type=type, link=link, ngsild_tenant=ngsild_tenant, replace_attrs_request=replace_attrs_request)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Attribute replace 
        api_instance.replace_attrs(entity_id, attr_id, local=local, type=type, link=link, ngsild_tenant=ngsild_tenant, replace_attrs_request=replace_attrs_request)
    except Exception as e:
...
# **replace_entity**
> replace_entity(entity_id, type=type, local=local, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Entity replacement by id 
        api_instance.replace_entity(entity_id, type=type, local=local, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
    except Exception as e:
...
# **update_attrs**
> update_attrs(entity_id, attr_id, local=local, type=type, link=link, ngsild_tenant=ngsild_tenant, replace_attrs_request=replace_attrs_request)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Partial Attribute Update 
        api_instance.update_attrs(entity_id, attr_id, local=local, type=type, link=link, ngsild_tenant=ngsild_tenant, replace_attrs_request=replace_attrs_request)
    except Exception as e:
...
# **update_entity**
> update_entity(entity_id, local=local, type=type, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Attributes of an Entity 
        api_instance.update_entity(entity_id, local=local, type=type, link=link, ngsild_tenant=ngsild_tenant, entity=entity)
    except Exception as e:
