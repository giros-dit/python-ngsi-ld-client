# ngsi_ld_client.ContextSourceIdentityInformationOperationsApi
...
from ngsi_ld_client.models.context_source_identity import ContextSourceIdentity
...
with ngsi_ld_client.ApiClient(configuration) as api_client:
    ...
    api_instance = ngsi_ld_client.ContextSourceIdentityInformationOperationsApi(api_client)
