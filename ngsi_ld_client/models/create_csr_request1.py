...
class CreateCSRRequest1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCSRRequest1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCSRRequest1:
        """Create an instance of CreateCSRRequest1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCSRRequest1.parse_obj(obj)

        _obj = CreateCSRRequest1.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
