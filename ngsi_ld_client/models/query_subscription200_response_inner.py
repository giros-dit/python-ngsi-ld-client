...
class QuerySubscription200ResponseInner(BaseModel):
    ...
    __properties = ["id", "type", "subscriptionName", "description", "entities", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "createdAt", "modifiedAt", "deletedAt", "status", "watchedAttributes", "throttling", "timeInterval"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuerySubscription200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QuerySubscription200ResponseInner:
        """Create an instance of QuerySubscription200ResponseInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuerySubscription200ResponseInner.parse_obj(obj)

        _obj = QuerySubscription200ResponseInner.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
