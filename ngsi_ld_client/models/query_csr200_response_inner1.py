...
class QueryCSR200ResponseInner1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryCSR200ResponseInner1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryCSR200ResponseInner1:
        """Create an instance of QueryCSR200ResponseInner1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryCSR200ResponseInner1.parse_obj(obj)

        _obj = QueryCSR200ResponseInner1.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
