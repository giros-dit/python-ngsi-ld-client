...
class QueryCSR200ResponseInner1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "registrationName", "description", "information", "tenant", "observationInterval", "managementInterval", "location", "observationSpace", "operationSpace", "expiresAt", "endpoint", "contextSourceInfo", "scope", "mode", "operations", "refreshRate", "management", "systemGeneratedAttrs", "status", "timesSent", "timesFailed", "lastSuccess", "lastFailure", "@context"]
