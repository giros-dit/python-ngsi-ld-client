...
class QueryEntity200ResponseInner1AllOf(BaseModel):
    """
    QueryEntity200ResponseInner1AllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryEntity200ResponseInner1AllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryEntity200ResponseInner1AllOf:
        """Create an instance of QueryEntity200ResponseInner1AllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryEntity200ResponseInner1AllOf.parse_obj(obj)

        _obj = QueryEntity200ResponseInner1AllOf.parse_obj({
