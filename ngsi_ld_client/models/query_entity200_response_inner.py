...
class QueryEntity200ResponseInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryEntity200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryEntity200ResponseInner:
        """Create an instance of QueryEntity200ResponseInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryEntity200ResponseInner.parse_obj(obj)

        _obj = QueryEntity200ResponseInner.parse_obj({
            "id": obj.get("id"),
