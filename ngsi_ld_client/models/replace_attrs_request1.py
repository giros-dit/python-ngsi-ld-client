...
class ReplaceAttrsRequest1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@context", "type", "value", "observedAt", "unitCode", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousValue", "object", "previousObject", "languageMap", "previousLanguageMap"]
