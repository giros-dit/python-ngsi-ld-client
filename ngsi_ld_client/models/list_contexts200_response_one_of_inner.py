...
class ListContexts200ResponseOneOfInner(BaseModel):
    """
    ListContexts200ResponseOneOfInner
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListContexts200ResponseOneOfInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListContexts200ResponseOneOfInner:
        """Create an instance of ListContexts200ResponseOneOfInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListContexts200ResponseOneOfInner.parse_obj(obj)

        _obj = ListContexts200ResponseOneOfInner.parse_obj({
