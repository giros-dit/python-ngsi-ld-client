...
class LanguageProperty(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageProperty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguageProperty:
        """Create an instance of LanguageProperty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LanguageProperty.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LanguageProperty) in the input: " + obj)

        _obj = LanguageProperty.parse_obj({
