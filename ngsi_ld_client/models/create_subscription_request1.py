...
class CreateSubscriptionRequest1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSubscriptionRequest1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSubscriptionRequest1:
        """Create an instance of CreateSubscriptionRequest1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSubscriptionRequest1.parse_obj(obj)

        _obj = CreateSubscriptionRequest1.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
