...
class TemporalQueryBatchRequest(BaseModel):
    ...
    temporal_q: TemporalQuery = Field(description="Temporal Query to be present only for \"Query Temporal Evolution of Entities\" operation (clause 5.7.4). ", alias="temporalQ")
    context: LdContext = Field(alias="@context")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "entities", "attrs", "q", "geoQ", "csf", "scopeQ", "lang", "temporalQ", "@context"]
