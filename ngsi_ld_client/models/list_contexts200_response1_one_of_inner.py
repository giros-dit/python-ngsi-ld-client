...
class ListContexts200Response1OneOfInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListContexts200Response1OneOfInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListContexts200Response1OneOfInner:
        """Create an instance of ListContexts200Response1OneOfInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListContexts200Response1OneOfInner.parse_obj(obj)

        _obj = ListContexts200Response1OneOfInner.parse_obj({
