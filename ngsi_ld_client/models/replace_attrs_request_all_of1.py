...
class ReplaceAttrsRequestAllOf1(BaseModel):
    """
    ReplaceAttrsRequestAllOf1
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReplaceAttrsRequestAllOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReplaceAttrsRequestAllOf1:
        """Create an instance of ReplaceAttrsRequestAllOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplaceAttrsRequestAllOf1.parse_obj(obj)

        _obj = ReplaceAttrsRequestAllOf1.parse_obj({
