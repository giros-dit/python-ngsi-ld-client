...
class RetrieveAttributes200ResponseOneOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveAttributes200ResponseOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveAttributes200ResponseOneOf:
        """Create an instance of RetrieveAttributes200ResponseOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveAttributes200ResponseOneOf.parse_obj(obj)

        _obj = RetrieveAttributes200ResponseOneOf.parse_obj({
