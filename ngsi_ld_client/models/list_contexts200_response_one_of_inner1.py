...
class ListContexts200ResponseOneOfInner1(BaseModel):
    """
    ListContexts200ResponseOneOfInner1
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListContexts200ResponseOneOfInner1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListContexts200ResponseOneOfInner1:
        """Create an instance of ListContexts200ResponseOneOfInner1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListContexts200ResponseOneOfInner1.parse_obj(obj)

        _obj = ListContexts200ResponseOneOfInner1.parse_obj({
