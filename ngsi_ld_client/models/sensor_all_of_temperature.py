...
class SensorAllOfTemperature(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SensorAllOfTemperature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SensorAllOfTemperature:
        """Create an instance of SensorAllOfTemperature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SensorAllOfTemperature.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SensorAllOfTemperature) in the input: " + obj)

        _obj = SensorAllOfTemperature.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
