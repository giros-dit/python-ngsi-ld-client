...
class RetrieveTypes200ResponseOneOf(BaseModel):
    """
    RetrieveTypes200ResponseOneOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveTypes200ResponseOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveTypes200ResponseOneOf:
        """Create an instance of RetrieveTypes200ResponseOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveTypes200ResponseOneOf.parse_obj(obj)

        _obj = RetrieveTypes200ResponseOneOf.parse_obj({
