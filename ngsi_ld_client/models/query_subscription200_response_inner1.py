...
class QuerySubscription200ResponseInner1(BaseModel):
    ...
    __properties = ["id", "type", "subscriptionName", "description", "entities", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "createdAt", "modifiedAt", "deletedAt", "status", "watchedAttributes", "throttling", "timeInterval", "@context"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuerySubscription200ResponseInner1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QuerySubscription200ResponseInner1:
        """Create an instance of QuerySubscription200ResponseInner1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuerySubscription200ResponseInner1.parse_obj(obj)

        _obj = QuerySubscription200ResponseInner1.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
