...
class QueryCSR200ResponseInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryCSR200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryCSR200ResponseInner:
        """Create an instance of QueryCSR200ResponseInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryCSR200ResponseInner.parse_obj(obj)

        _obj = QueryCSR200ResponseInner.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
