...
class ListContexts200Response1OneOfInner1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListContexts200Response1OneOfInner1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListContexts200Response1OneOfInner1:
        """Create an instance of ListContexts200Response1OneOfInner1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListContexts200Response1OneOfInner1.parse_obj(obj)
