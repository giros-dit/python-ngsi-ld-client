...
class QueryEntity200ResponseInner1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryEntity200ResponseInner1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryEntity200ResponseInner1:
        """Create an instance of QueryEntity200ResponseInner1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryEntity200ResponseInner1.parse_obj(obj)

        _obj = QueryEntity200ResponseInner1.parse_obj({
            "id": obj.get("id"),
