...
class SubscriptionOnChange(BaseModel):
    ...
    notification: Optional[NotificationParams] = Field(default=None, description="Notification details. ")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "subscriptionName", "description", "entities", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "systemGeneratedAttrs", "status", "jsonldContext", "watchedAttributes", "throttling"]
