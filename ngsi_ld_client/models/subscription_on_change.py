...
class SubscriptionOnChange(BaseModel):
    ...
    __properties = ["id", "type", "subscriptionName", "description", "entities", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "watchedAttributes", "throttling", "createdAt", "modifiedAt", "deletedAt", "status"]
