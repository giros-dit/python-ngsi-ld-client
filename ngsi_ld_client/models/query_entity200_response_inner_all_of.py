...
class QueryEntity200ResponseInnerAllOf(BaseModel):
    """
    QueryEntity200ResponseInnerAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryEntity200ResponseInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryEntity200ResponseInnerAllOf:
        """Create an instance of QueryEntity200ResponseInnerAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryEntity200ResponseInnerAllOf.parse_obj(obj)

        _obj = QueryEntity200ResponseInnerAllOf.parse_obj({
