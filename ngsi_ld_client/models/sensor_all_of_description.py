...
class SensorAllOfDescription(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SensorAllOfDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SensorAllOfDescription:
        """Create an instance of SensorAllOfDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SensorAllOfDescription.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SensorAllOfDescription) in the input: " + obj)

        _obj = SensorAllOfDescription.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
