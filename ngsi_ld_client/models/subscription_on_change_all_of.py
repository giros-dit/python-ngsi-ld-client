...
class SubscriptionOnChangeAllOf(BaseModel):
    """
    ...
    __properties = ["watchedAttributes", "throttling", "createdAt", "modifiedAt", "deletedAt", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionOnChangeAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionOnChangeAllOf:
        """Create an instance of SubscriptionOnChangeAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionOnChangeAllOf.parse_obj(obj)

        _obj = SubscriptionOnChangeAllOf.parse_obj({
