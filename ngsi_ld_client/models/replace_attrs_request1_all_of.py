...
class ReplaceAttrsRequest1AllOf(BaseModel):
    """
    ReplaceAttrsRequest1AllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReplaceAttrsRequest1AllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReplaceAttrsRequest1AllOf:
        """Create an instance of ReplaceAttrsRequest1AllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplaceAttrsRequest1AllOf.parse_obj(obj)

        _obj = ReplaceAttrsRequest1AllOf.parse_obj({
