...
# body param
SchemaForRequestBodyApplicationJson = ContextSourceRegistration
SchemaForRequestBodyApplicationLdjson = ContextSourceRegistration


request_body_context_source_registration = api_client.RequestBody(
    content={
...
class RegisterCsource(api_client.Api):
    ...
    def register_csource(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_context_source_registration.serialize(body, content_type)
