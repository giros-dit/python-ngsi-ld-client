...
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = SubscriptionList
SchemaFor200ResponseBodyApplicationLdjson = SubscriptionList
...
class RetrieveCSourceSubscriptions(api_client.Api):

    def retrieve_c_source_subscriptions(
        self: api_client.Api,
