...
# body param
SchemaForRequestBodyApplicationJson = Subscription
SchemaForRequestBodyApplicationLdjson = Subscription


request_body_subscription = api_client.RequestBody(
    content={
...
class CreateCSourceSubscription(api_client.Api):

    def create_c_source_subscription(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subscription.serialize(body, content_type)
