...
_path = '/temporal/entities/{entityId}'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = EntityTemporal
SchemaFor200ResponseBodyApplicationLdjson = EntityTemporal
...
class RetrieveEntityTemporalById(api_client.Api):
