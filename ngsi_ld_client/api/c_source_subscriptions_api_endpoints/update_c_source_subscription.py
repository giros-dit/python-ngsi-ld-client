...
# body param
SchemaForRequestBodyApplicationJson = SubscriptionFragment
SchemaForRequestBodyApplicationLdjson = SubscriptionFragment


request_body_subscription_fragment = api_client.RequestBody(
    content={
...
class UpdateCSourceSubscription(api_client.Api):

    def update_c_source_subscription(
        self: api_client.Api,
        ...
        _fields = None
        _body = None
        serialized_data = request_body_subscription_fragment.serialize(body, content_type)
