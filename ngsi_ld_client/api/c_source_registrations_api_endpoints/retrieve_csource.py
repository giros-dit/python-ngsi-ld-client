...
# path params
RegistrationIdSchema = StrSchema
...
_path = '/csourceRegistrations/{registrationId}'
_method = 'GET'
SchemaFor200ResponseBodyApplicationJson = ContextSourceRegistration
SchemaFor200ResponseBodyApplicationLdjson = ContextSourceRegistration
...
class RetrieveCsource(api_client.Api):
