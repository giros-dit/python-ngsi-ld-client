...
request_path_attr_id = api_client.PathParameter(
    name="attrId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AttrIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = EntityTemporalFragment
SchemaForRequestBodyApplicationLdjson = EntityTemporalFragment


request_body_entity_temporal_fragment = api_client.RequestBody(
    content={
...
_path = '/temporal/entities/{entityId}/attrs/{attrId}/{instanceId}'
_method = 'PATCH'
...
class ModifyEntityTemporalAttrInstance(api_client.Api):
    ...
    def modify_entity_temporal_attr_instance(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_entity_temporal_fragment.serialize(body, content_type)
