...
# body param
SchemaForRequestBodyApplicationJson = Entity
SchemaForRequestBodyApplicationLdjson = Entity


request_body_entity = api_client.RequestBody(
    content={
...
class CreateEntity(api_client.Api):
    ...
    def create_entity(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_entity.serialize(body, content_type)
