...
Python client for [`ETSI GS CIM 009 V1.6.1`](https://www.etsi.org/deliver/etsi_gs/CIM/001_099/009/01.06.01_60/gs_CIM009v010601p.pdf) cr>
...
To generate the code derived from the particular schemas defined within the OpenAPI, the [OpenAPI Generator Docker image option](https:>
```bash
$ docker run --rm -v ${PWD}:/python-ngsi-ld-client openapitools/openapi-generator-cli generate -i /python-ngsi-ld-client/schemas/ngsi-l>
```
